...
// o	Acesse a Google Play Console e crie um novo projeto para seu aplicativo.
// o	Preencha as informações básicas, como nome, descrição e categoria do aplicativo.
// 2.	Upload do APK/Bundle
// o	Na seção de gerenciamento de versões, faça o upload do APK ou bundle gerado.
// o	Preencha as informações de lançamento, incluindo notas de versão e direcionamentos de público-alvo.
// 3.	Preencher Detalhes da Loja
// o	Adicione capturas de tela, ícones e descrições detalhadas.
// o	Configure os preços e países onde o aplicativo estará disponível.
// 4.	Submeter para Revisão
// o	Revise todas as informações e submeta o aplicativo para revisão.
// o	Acompanhe o status da revisão na Google Play Console.
